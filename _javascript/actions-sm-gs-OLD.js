$(document).ready(function(){
	...
	if (isMobile == false) {
		...
		tweens3.push(TweenMax.to(prod, 0.5,
			{
					...
					var curPro = hatsPro[prod.curProd],
						...
						if (prod.mouse > sMouse) {
							if (prod.it < prod.curProd) {
								...
								TweenMax.to(prevPro, .1, {opacity: 0,
									onStart: function(){
									...
									onComplete: function(){
										...
										TweenMax.to(curPro, .1, {opacity: 1});
							...
							if (prod.it < prod.curProd) {
								TweenMax.to(curPro, .1, {opacity: 0,
									onStart: function(){
									...
									onComplete: function(){
										...
										TweenMax.set(curPro, {className: "-=active"});
										TweenMax.set(prevPro, {className: "+=active"});
										TweenMax.to(prevPro, .1, {opacity: 1});
										TweenMax.set(prevPro, {className: "+=active"});
										pColorCont.attr("data-color", curColor);
								}});
							}
		...
		tweens5.push(TweenMax.to(sweats, 0.5,
			{
